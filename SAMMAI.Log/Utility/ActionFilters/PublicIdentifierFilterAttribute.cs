...
namespace SAMMAI.Log.Utility.ActionFilters
{
    ...
    public class PublicIdentifierFilterAttribute : Attribute, IAuthorizationFilter
    {
        ...
        public static AuthDI GetDI(IServiceProvider serviceProvider)
        {
            return new AuthDI()
            {
                ...
                Logger = serviceProvider.GetService<ILogger<PublicIdentifierFilterAttribute>>() ?? throw new ArgumentNullException(nameof(ILogger<PublicIdentifierFilterAttribute>))
            };
        }
    }
    ...
    public class AuthDI
    {
        ...
        public required ILogger<PublicIdentifierFilterAttribute> Logger { get; set; }
    }
}
